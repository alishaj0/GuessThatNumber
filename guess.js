...
while (restartGame){
    ...
    // Verifies the user's entry for a range number is a number greater than zero. (NOTE: ALL numbers, positive and negative, have a default boolean value of true, except for zero, which has a default boolean value of false. Also, NaN has a default boolean value of false also)
